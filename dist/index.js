...
try {
    ...
    const message = [
        (0, util_1.getEnvRequired)('TASK_NAME'),
        (0, util_1.getEnvRequired)('GITHUB_SHA'),
        new Date(timestamp),
        timestamp
    ]
        .join(' ');
    ...
    if (pull) {
        util.git.pull({ rebase });
    }
    if (push) {
        util.git.push({ remote: remote.name, branch, force });
    }
}
catch (err) {
...
function addAll() {
    ...
    const cmd = ['git', 'add'];
    cmd.push('-A');
    const result = [...(_c = (_b = (_a = (0, child_process_1.execSync)(cmd.join(' '))) === null || _a === void 0 ? void 0 : _a.toString()) === null || _b === void 0 ? void 0 : _b.split('\n')) === null || _c === void 0 ? void 0 : _c.filter((p) => (p))];
    core.info(cmd.join(' '));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.branch = exports.revParse = void 0;
const core = __importStar(__nccwpck_require__(186));
const child_process_1 = __nccwpck_require__(129);
...
function branch({ upstream, force, name }) {
    var _a, _b, _c;
    const cmd = ['git', 'branch'];
    if (upstream) {
        cmd.push(...['--set-upstream-to', upstream]);
    }
    if (force) {
        cmd.push('-f');
    }
...
const core = __importStar(__nccwpck_require__(186));
const child_process_1 = __nccwpck_require__(129);
function push({ force, remote, branch }) {
    var _a, _b, _c;
    const cmd = ['git', 'push'];
    cmd.push(remote || '');
    cmd.push(branch || '');
...
__exportStar(__nccwpck_require__(39), exports);
