...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.pullWithRebase = void 0;
const Exec_1 = __nccwpck_require__(909);
function pullWithRebase({ remote }) {
    const cmd = `git pull ${remote !== null && remote !== void 0 ? remote : ''} --rebase`;
    return (0, Exec_1.execSyncString)(cmd);
}
exports.pullWithRebase = pullWithRebase;
